...
const SearchManufacturer = ({ manufacturer, setManufacturer}: manufacturerProps) => {
    ...
    const filterdManufactures = query === "" ? manufacturers : manufacturers.filter((item)=>(
        ...
        <Combobox value={manufacturer} onChange={setManufacturer}>
            <div className='relative w-full'>
                ...
                >
                    <Combobox.Options>
                        {
                            filterdManufactures.map((item)=>(
                                <Combobox.Option
                                    key={item}
                                    className={({active})=> `realtive search-manufacturer__option
